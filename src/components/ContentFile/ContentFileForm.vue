                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-right animate__animated animate__fadeIn">
                                ...
                                <button class="btn btn-primary" v-on:click="PrepareForm()">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        mounted() {
            ...
            /** Mensagem montada quando for montado o componente */
            console.log('Componente "ContentFileForm", montado com sucesso');
