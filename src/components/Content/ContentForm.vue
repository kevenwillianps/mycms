<template>
    ...
    <div>
        ...
        <div class="card shadow-sm border-dashed" v-else>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            /** Listagem de 'CategoriaDeConteúdos' **/
            ListContentCategory() {
                    ...
                    .then(response => {
                        ...
                        switch (response.data.cod){
                            ...
                            default :
                                ...
                                /** Guardo minha resposta em uma váriavel **/
                                this.query.result_content_categories = response.data.result;
            ...
            async PrepareForm() {
                ...
                for (let i = 0; i < this.inputs_file.part.length; i++) {
                    ...
                    for (let j = 0; j < this.inputs_file.part[i].length; j++) {
                        ...
                        await this.SendForm(this.inputs.content_id, this.inputs.situation_id, this.inputs_file.position[i], this.inputs_file.highlighter_file_id[i], this.inputs_file.name[i], j, this.inputs_file.part[i][j], this.inputs_file.part[i].length, this.inputs_file.extension[i])
            ...
            SendForm: async(content_id, situation_id, position, highlighter_file_id, name, pointer, part, length, extension) => {
