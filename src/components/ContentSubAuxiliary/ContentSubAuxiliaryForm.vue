<template>
    ...
    <div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 animate__animated animate__fadeIn">
                ...
                <h4>
                    ...
                    <i class="far fa-folder-open mr-1"></i>Sub-Conteúdo Auxiliar
            ...
            <div class="col-md-6 text-right animate__animated animate__fadeIn">
                ...
                <h4>
                    ...
                    <router-link v-bind:to="{name : 'content-sub-datagrid', params : {user_id : session.user_id, user_function_id : session.user_function_id, content_id : inputs.content_id}}" class="btn btn-default">
        ...
        <div class="card shadow-sm border-dashed animate__animated animate__fadeIn" v-else>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-right">
                        ...
                        <button class="btn btn-default" v-on:click="Save()" v-if="inputs.title">
    ...
    export default {
        ...
        methods: {
            ...
            Form() {
                ...
                /** Envio uma requisição ao meu backend **/
                axios.post('router.php?TABLE=CONTENT_SUB_AUXILIARY&ACTION=CONTENT_SUB_AUXILIARY_EDIT_FORM', {
                    inputs: this.inputs
                })
        ...
        mounted() {
            ...
            if (this.$route.params.content_sub_id > 0 && this.$route.params.action == 1) {

                this.Form();

            }
            console.log('Componente "ContentSubAuxiliaryForm", montado com sucesso');
