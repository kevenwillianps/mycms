...
class Content
{
    ...
    public function save($content_id, $content_category_id, $user_id, $situation_id, $highlighter_id, $menu_position, $url, $title, $title_menu, $description, $content_resume, $content_complete, $start_date, $closing_date, $date_register, $date_update)
    {
        ...
        if ($this->content_id == 0) {
            ...
            /** Consulta SQL **/
            $sql = "INSERT INTO content(content_id, content_category_id, user_id, situation_id, highlighter_id, menu_position, url, title, title_menu, description,content_resume, content_complete, start_date, closing_date, date_register, date_update) VALUES(:content_id, :content_category_id, :user_id, :situation_id, :highlighter_id, :menu_position, :url, :title, :title_menu, :description, :content_resume, :content_complete, :start_date, :closing_date, :date_register, :date_update);";
        } else {

            /** Consulta SQL **/
            $sql = "UPDATE content set content_id = :content_id, content_category_id = :content_category_id, user_id = :user_id, situation_id = :situation_id, highlighter_id = :highlighter_id, menu_position = :menu_position, url = :url, title = :title, title_menu = :title_menu,description = :description, content_resume = :content_resume, content_complete = :content_complete, start_date = :start_date, closing_date = :closing_date, date_register = :date_register, date_update = :date_update WHERE content_id = :content_id";
        }
