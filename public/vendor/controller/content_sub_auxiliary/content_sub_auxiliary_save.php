...
try {
    ...
    if ($main->verifySession()){
        ...
        if (count($message) > 0) {
            ...
            /** Executo o método **/
            $contentSubAuxiliary->save($content_sub_id, $content_id, $content_sub_auxiliary_id, $user_id, $situation_id, $highlighter_id, $menu_position, $url, $title, $title_menu, $description, $content_resume, $content_complete, $date_register, $date_update);
