    ...
    <div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-default mb-0">
            ...
            <div class="navbar-brand">
                ...
                <router-link v-bind:to="{name : 'content-sub-file-datagrid', params : {user_id : session.user_id, user_function_id : session.user_function_id, content_id : inputs.content_id, content_sub_id : inputs.content_sub_id }}">
