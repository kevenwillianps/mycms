...
try {
    ...
    if ($main->verifySession()){
        ...
        while ($i < count($inputs['inputs']))
        {
            ...
            $content_file_id     = isset($inputs['inputs'][$i]['content_file_id'])     ? (int)$main->antiInjection($inputs['inputs'][$i]['content_file_id'])     : 0;
            $content_id          = isset($inputs['inputs'][$i]['content_id'])          ? (int)$main->antiInjection($inputs['inputs'][$i]['content_id'])          : 0;
