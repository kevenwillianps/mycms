...
try {
    ...
    if ($main->verifySession()){
        ...
        $contact_id = isset($inputs['inputs']['contact_id']) ? (int)$main->antiInjection($inputs['inputs']['contact_id']) : 0;
        ...
        if (count($message) > 0) {
            ...
            if (isset($row)) {
                ...
                if ($row->contact_id > 0) {
                    ...
                    if ($contacts->delete($row->contact_id)) {
