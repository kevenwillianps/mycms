    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                inputs: {
                    ...
                    highlighter_file_id: this.$route.params.highlighter_file_id,
                    name: null,
                    description: null,
                    date_register: null,
                    date_update: null,
        ...
        methods: {
            ...
            EditForm() {
                ...
                axios.post('router.php?TABLE=HIGHLIGHTER_FILE&ACTION=HIGHLIGHTER_FILE_EDIT_FORM', {
                    inputs: this.inputs
                })
            ...
            Save() {
                ...
                axios.post('router.php?TABLE=HIGHLIGHTER_FILE&ACTION=HIGHLIGHTER_FILE_SAVE', {
                    inputs: this.inputs
                })
        ...
        mounted() {
            ...
            if (this.$route.params.highlighter_file_id > 0) {

                this.EditForm();

            }
            console.log("Componente 'HighlighterFileForm', montado com sucesso!");
