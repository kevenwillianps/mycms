...
try {
   ...
   **/
    ...
    $c_execute        = isset($inputs['inputs']['c_execute'])        ? (int)$Main->anti_injection($inputs['inputs']['c_execute'])        : 0;
    $r_execute        = isset($inputs['inputs']['r_execute'])        ? (int)$Main->anti_injection($inputs['inputs']['r_execute'])        : 0;
    $u_execute        = isset($inputs['inputs']['u_execute'])        ? (int)$Main->anti_injection($inputs['inputs']['u_execute'])        : 0;
    $d_execute        = isset($inputs['inputs']['d_execute'])        ? (int)$Main->anti_injection($inputs['inputs']['d_execute'])        : 0;
